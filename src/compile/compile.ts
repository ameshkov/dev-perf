 ...
 * asset, and writes `report.md` plus the `assets/` directory into the
 * output directory. Progress goes to stderr through the level-based
 * logger; stdout carries nothing but the path of the written report.
 */

/**
 * Short period labels for chart axes: day and week become `Jan 5`,
 * month `2026-01`, quarter `Q1 2026`, year `2026`. Mirrors
 * `src/compile/period-label.ts` of the parent CLI.
 */
